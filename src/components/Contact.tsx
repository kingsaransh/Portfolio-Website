      ...
      <div className="contact-container">
        ...
        <div className="contact-flex">
          <div className="contact-box">
            <h4>Email</h4>
            <p>
              <a href="mailto:saranshsaini635@gmail.com" data-cursor="disable">
                saranshsaini635@gmail.com
              </a>
            </p>
            <h4>Phone</h4>
            <p>
              <a href="tel:+917351952643" data-cursor="disable">
                +91 7351952643
              </a>
            </p>
            <h4>Location</h4>
          ...
          <div className="contact-box">
            <h2>
              Designed and Developed <br /> by <span>Saransh Saini</span>
            </h2>
            <h5>
              <MdCopyright /> 2026
            </h5>
